...
- All newly created test boards generated by the code must use default title `TEST` and follow the sequential format: `TEST-BOARD-001` (starting from `TEST-BOARD-001` and incrementing).
